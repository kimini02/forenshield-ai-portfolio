...
### Models 버킷 (`forenshield-models-000000000000`)

```text
로컬  models/deploy/video/xception/v1.0.0/
  ↔  s3://forenshield-models-000000000000/video/xception/v1.0.0/

로컬  data/golden/v1/  (선택 백업)
  ↔  s3://forenshield-models-000000000000/golden-set/v1/
```

### Evidence 버킷 (`forenshield-evidence-000000000000`)
