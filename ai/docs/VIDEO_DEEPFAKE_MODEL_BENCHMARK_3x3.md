...
> **작성 기준일:** 2026-06-22  
> **평가 환경:** welabs GPU (`sk4team@203.0.113.10`, `~/forenShield-ai`)  
> **S3 evidence 버킷:** `forenshield-evidence-000000000000`  
...
```text
s3://forenshield-evidence-000000000000/cases/test/<prefix>/<RUN_ID>/
