...
> **작성일:** 2026-06-22  
> **분석 환경:** welabs GPU (`sk4team@203.0.113.10`, `~/forenShield-ai`)  
...
```powershell
Get-Content c:\sw_study\finalpjt\ai\scripts\eval\gpu_install_and_run_threshold.sh -Raw | ssh sk4team@203.0.113.10 "bash -s"
```
...
export S3_EVIDENCE_BUCKET=s3://forenshield-evidence-000000000000
unset AWS_PROFILE
