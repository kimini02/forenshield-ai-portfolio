...
export S3_MODELS_BUCKET=forenshield-models-000000000000
export S3_EVIDENCE_BUCKET=forenshield-evidence-000000000000
EOF

write_if_missing "${ROOT}/config/buckets.yaml" <<'EOF'
# S3 버킷·prefix — 상세: ai-forensic/docs/FORENSHIELD_AI_GPU_WORKSTATION.md
buckets:
  evidence: forenshield-evidence-000000000000
  models: forenshield-models-000000000000
